...
import com.github.paganini2008.springplayer.common.es.KeywordResultSetSlice;
import com.github.paganini2008.springplayer.common.es.QueryClause;

/**
 * 
 * AppLogKeywordQueryResultSetSlice
 *
 * @author Fred Feng
 * @version 1.0.0
 */
public class AppLogKeywordQueryResultSetSlice extends KeywordResultSetSlice<AppLog> {
	...
	public AppLogKeywordQueryResultSetSlice(ElasticsearchRestTemplate elasticsearchTemplate, String keyword, SearchFilterQuery query) {
		super(elasticsearchTemplate, keyword, QueryClause.SHOULD, DEFAULT_SEARCH_FIELDS, AppLog.class);
		this.query = query;
	}
