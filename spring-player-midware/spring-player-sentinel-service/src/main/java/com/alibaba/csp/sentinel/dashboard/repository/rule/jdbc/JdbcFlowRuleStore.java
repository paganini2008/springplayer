 ...
 * @version 2.0.5
 */
public class JdbcFlowRuleStore extends JdbcRuleRepositorySupport<FlowRuleEntity> {

	public JdbcFlowRuleStore(SentinelRuleService sentinelRuleService, RedisAtomicLong idGen) {
		super(FlowRuleEntity.class, sentinelRuleService, idGen);
	}
