...
public class KafkaLogAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
	...
	private String topic = KAFKA_TOPIC_LOG_COLLECTOR;
	...
	public KafkaLogAppender() {
		kafkaProperties.setProperty("key.serializer", "org.apache.kafka.common.serialization.IntegerSerializer");
		kafkaProperties.setProperty("value.serializer", "com.github.paganini2008.springplayer.log.utils.LogEntryJsonSerializer");
	}
	...
	protected void append(ILoggingEvent eventObject) {
		...
		logEntry.setTimestamp(eventObject.getTimeStamp());

		producer.send(new ProducerRecord<String, LogEntry>(topic, logEntry));
