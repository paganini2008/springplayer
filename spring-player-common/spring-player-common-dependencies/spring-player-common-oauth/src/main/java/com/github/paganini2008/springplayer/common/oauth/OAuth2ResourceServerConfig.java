...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(ResourceServerSecurityConfigurer resources) {
		resources.tokenStore(tokenStore()).authenticationEntryPoint(new FailureAuthenticationEntryPoint(objectMapper, messageLocalization))
				.tokenExtractor(tokenExtractor).accessDeniedHandler(new GlobalAccessDeniedHandler(objectMapper, messageLocalization));
	}
