...
/**
 * 
 * KeywordResultSetSlice
 *
 * @author Fred Feng
 * @version 1.0.0
 */
public class KeywordResultSetSlice<T> extends AbstractQueryResultSetSlice<T> {

	private final String keyword;
	private final QueryClause queryClause;
	private final String[] searchFields;

	public KeywordResultSetSlice(ElasticsearchRestTemplate elasticsearchTemplate, String keyword, QueryClause queryClause,
