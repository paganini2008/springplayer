...
import com.github.paganini2008.springplayer.swagger.SwaggerResourceProperties.Authorization;
...
public class SwaggerResourceConfig {
	...
	public ApiInfo apiInfo(SwaggerResourceProperties swaggerProperties) {
		...
		if (swaggerProperties.getContact() != null) {
			com.github.paganini2008.springplayer.swagger.SwaggerResourceProperties.Contact c = swaggerProperties.getContact();
